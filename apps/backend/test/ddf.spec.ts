...
import ddfSample from './fixtures/samples/ddfSample.json';
...
describe('DDF', () => {
  it('Verifies DDF TXT to DDF json', () => {
    ...
    expect(Object.values(ddf.details[7])).toEqual(Object.values(ddfSample[1]));
    expect(Object.values(ddf.details[10])).toEqual(Object.values(ddfSample[2]));
  });
});
