...
describe('TDI34', () => {
  it('Verifies TDI TXT to TDI json', () => {
    ...
    expect(Object.values(tdi34.details[3])).toEqual(Object.values(tdi34Sample[0]))
    expect(Object.values(tdi34.details[7])).toEqual(Object.values(tdi34Sample[1]))
    expect(Object.values(tdi34.details[9])).toEqual(Object.values(tdi34Sample[2]))
  })
})
