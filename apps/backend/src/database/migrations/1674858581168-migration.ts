...
export class migration1674858581168 implements MigrationInterface {
  name = 'migration1674858581168';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "method" integer NOT NULL, "amount" numeric NOT NULL, "currency" character varying, "exchange_rate" numeric, "deposit_id" character varying, "match" boolean NOT NULL DEFAULT false, "transaction" uuid, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "transaction" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "transaction_id" character varying NOT NULL, "transaction_date" date NOT NULL, "transaction_time" character varying, "payment_total" numeric NOT NULL, "location_id" integer NOT NULL, CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
