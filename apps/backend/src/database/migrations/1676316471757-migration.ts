...
export class migration1676316471757 implements MigrationInterface {
  name = 'migration1676316471757';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "log_entity" ("id" SERIAL NOT NULL, "context" character varying NOT NULL, "message" character varying NOT NULL, "level" character varying NOT NULL, "creationDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_db6e55781ba6e3d4fd6485cca24" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
