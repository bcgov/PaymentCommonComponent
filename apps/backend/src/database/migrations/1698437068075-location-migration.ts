...
export class Migration1698437068075 implements MigrationInterface {
  name = 'Migration1698437068075';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "location" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying(255) NOT NULL, "program_code" character varying(10) NOT NULL, "program_desc" character varying(255) NOT NULL, "ministry_client" character varying(3) NOT NULL, "resp_code" character varying(5) NOT NULL, "service_line_code" character varying(5) NOT NULL, "stob_code" character varying(4) NOT NULL, "project_code" character varying(7) NOT NULL, "source_id" character varying(15) NOT NULL, "location_id" integer NOT NULL, CONSTRAINT "UQ_62c907775331b5aa98ec8daf7dd" UNIQUE ("id", "location_id", "source_id"), CONSTRAINT "PK_62c907775331b5aa98ec8daf7dd" PRIMARY KEY ("id", "source_id", "location_id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" ALTER COLUMN "source_id" TYPE character varying(15)`
    );
    await queryRunner.query(
