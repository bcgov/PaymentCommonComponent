...
export class Migration1698262832406 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "location_bank" ("id" integer NOT NULL, "source_id" character varying(10), "location" integer, CONSTRAINT "id" UNIQUE ("id", "source_id", "location"), CONSTRAINT "PK_eeba479525aaefa12e7f3b3be68" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "id_location_idx" ON "location_bank" ("id", "source_id", "location") `
    );
    await queryRunner.query(
      `CREATE TABLE "location_merchant" ("id" integer NOT NULL, "source_id" character varying(10), "location" integer, CONSTRAINT "UQ_169c6b566ce3e496196c73e4347" UNIQUE ("id", "source_id", "location"), CONSTRAINT "PK_b9e23b9c6e585e7466134d76a93" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD CONSTRAINT "FK_35e209ebc6bd47ac37526907a5b" FOREIGN KEY ("location_id", "source_id", "location") REFERENCES "location"("location_id","source_id","id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" DROP CONSTRAINT "FK_35e209ebc6bd47ac37526907a5b"`
    );
