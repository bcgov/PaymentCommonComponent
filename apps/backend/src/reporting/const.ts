...
export const detailedReportColumns = [
  ...
  { header: 'Txn Date', key: 'txn_date' },
  { header: 'Time', key: 'time' },
  { header: 'Deposit/Close Date', key: 'close_date' },
  { header: 'Uploaded On', key: 'uploaded_date' },
  { header: 'In Progress On', key: 'in_progress_date' },
  { header: 'Reconciled On', key: 'reconciled_date' },
